...
class OffenderEventsTransformer(@Value("\${aq.timezone.daylightsavings}") val aqHasDaylightSavings: Boolean) {
  ...
  fun offenderEventOf(xtag: Xtag?): OffenderEvent? {
    ...
    return try {
      when (xtag.eventType) {
        ...
        "OFFENDER_OFFICIAL_VISIT_VISTORS-INSERTED", "OFFENDER_OFFICIAL_VISIT_VISTORS-UPDATED", "OFFENDER_OFFICIAL_VISIT_VISTORS-DELETED" -> officialVisitVisitorEventOf(xtag)
        ...
        "STAFF_USER_ACCOUNTS-INSERTED", "STAFF_USER_ACCOUNTS-UPDATED", "STAFF_USER_ACCOUNTS-DELETED" -> staffUserAccountEventOf(xtag)
        ...
        "USER_CASELOAD_ROLES-INSERTED", "USER_CASELOAD_ROLES-DELETED" -> userCaseloadRoleEventOf(xtag)
  ...
  private fun officialVisitVisitorEventOf(xtag: Xtag) = VisitVisitorEvent(
    eventType = xtag.eventType!!.replace("VISTORS", "VISITORS"),
    eventDatetime = xtag.nomisTimestamp,
    visitVisitorId = xtag.content.p_offender_visit_visitor_id!!.toLong(),
    bookingId = xtag.content.p_offender_book_id?.toLong(),
    offenderIdDisplay = xtag.content.p_offender_id_display,
    nomisEventType = xtag.eventType,
    visitId = xtag.content.p_offender_visit_id!!.toLong(),
  ...
  private fun staffUserAccountEventOf(xtag: Xtag) = StaffUserAccountEvent(
    eventType = xtag.eventType,
    eventDatetime = xtag.nomisTimestamp,
    staffId = xtag.content.p_staff_id!!.toLong(),
  ...
  private fun militaryEventOf(xtag: Xtag) = MilitaryEvent(
    ...
    bookingId = xtag.content.p_offender_book_id!!.toLong(),
    offenderIdDisplay = xtag.content.p_offender_id_display!!,
    militarySequence = xtag.content.p_military_seq!!.toInt(),
    auditModuleName = xtag.content.p_audit_module_name ?: "UNKNOWN_MODULE",
  )
