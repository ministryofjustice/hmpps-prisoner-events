...
CREATE INDEX "OFFENDER_EXTERNAL_MOVEMENTS_N2" ON "OFFENDER_EXTERNAL_MOVEMENTS" ("TO_AGY_LOC_ID", "MOVEMENT_TYPE", "ACTIVE_FLAG");
CREATE INDEX "OFFENDER_EXTERNAL_MOVEMENTS_N4" ON "OFFENDER_EXTERNAL_MOVEMENTS" ("FROM_AGY_LOC_ID");
CREATE INDEX "OFFENDER_EXT_MOVEMENTS_NI5" ON "OFFENDER_EXTERNAL_MOVEMENTS" ("OFFENDER_BOOK_ID", "MOVEMENT_DATE", "MOVEMENT_TYPE", "MOVEMENT_SEQ");
CREATE INDEX "OFFENDER_EXT_MOVEMENTS_X01" ON "OFFENDER_EXTERNAL_MOVEMENTS" ("MOVEMENT_DATE", "OFFENDER_BOOK_ID");
CREATE INDEX "OFF_EM_INT_SR_F1" ON "OFFENDER_EXTERNAL_MOVEMENTS" ("INTERNAL_SCHEDULE_TYPE", "INTERNAL_SCHEDULE_REASON_CODE");
CREATE INDEX "OFF_EM_MOVE_RSN_F1" ON "OFFENDER_EXTERNAL_MOVEMENTS" ("MOVEMENT_TYPE", "MOVEMENT_REASON_CODE");
CREATE INDEX "OFF_EXT_MOV_ADDR_FK" ON "OFFENDER_EXTERNAL_MOVEMENTS" ("TO_ADDRESS_ID");
CREATE INDEX "OFF_EXT_MOV_FROM_ADDR_FK" ON "OFFENDER_EXTERNAL_MOVEMENTS" ("FROM_ADDRESS_ID");

GRANT SELECT ON OFFENDER_EXTERNAL_MOVEMENTS TO HMPPS_EVENT_API;
GRANT INSERT ON OFFENDER_EXTERNAL_MOVEMENTS TO HMPPS_EVENT_API;
GRANT DELETE ON OFFENDER_EXTERNAL_MOVEMENTS TO HMPPS_EVENT_API;
CREATE PUBLIC SYNONYM OFFENDER_EXTERNAL_MOVEMENTS FOR SYS.OFFENDER_EXTERNAL_MOVEMENTS;
